...
export class MenuService {
  ...
  addExtra(extraData: any) {
    return this._http.post('http://localhost:3000/api/menu/newExtra', {
      extraData: extraData
    }).toPromise();
  }
  updateExtra(extraData: any, extraId: any) {
      return this._http.post('http://localhost:3000/api/menu/updateExtra',{
        extraData: extraData,
        params: {
          id: extraId
        }
  ...
  showExtra() {
      return this._http.get('http://localhost:3000/api/menu/listAllExtra').toPromise()
  }

  deleteExtra(extraId: any) {
      return this._http.post('http://localhost:3000/api/menu/deleteExtra',{
        extraId: extraId
    }).toPromise()
  }
}